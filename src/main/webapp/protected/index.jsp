...
<html>
    <head>
        ...
        <link rel="stylesheet" href="front-end-frameworks/external/jquery-ui/jquery-ui.min.css"/>
        <script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
        <script src="front-end-frameworks/external/jquery-ui/jquery-ui.min.js"></script>
        ...
        <script src="front-end-frameworks/external/saveSvgAsPng.min.js"></script>
        <script src="front-end-frameworks/javascript/pnnl.min.js"></script>        
    </head>
    <body>
                ...
                <div class="tab-body" id="tab-body">
                    <ul class="tabs">
                        <li class="tab-item-container">
                            <input type="radio" name="active-tab" class="tab" id="cdf-tab" value="cdf-tab-content"/>
                            <span class="tab-title">cdf</span>
                        </li>
                        <li class="tab-item-container">
                            <input type="radio" name="active-tab" class="tab" id="hdf-tab" value="hdf-tab-content"/>
                            <span class="tab-title">hdf</span>
                        </li>
                        <li class="tab-item-container">
                            <input type="radio" name="active-tab" class="tab" id="excel-tab" value="excel-tab-content"/>
                            <span class="tab-title">excel</span>
                        </li>
                        <li class="tab-item-container">
                            <input type="radio" name="active-tab" class="tab images" id="images-tab" value="images-tab-content"/>
                            <span class="tab-title">images</span>
                        </li>
                        <li class="tab-item-container">
                            <input type="radio" name="active-tab" class="tab images" id="optical-tab" value="optical-tab-content"/>
                            <span class="tab-title">optical images</span>
                        </li>
                        <li class="tab-item-container">
                            <input type="radio" name="active-tab" class="tab images" id="rois-roiImages-tab" value="rois-roiImages-tab-content"/>
                            <span class="tab-title">ROI images</span>
                        </li>
                    </ul>
            ...
            <div class='window my-dialog warp-window'>
                ...
                <div class='my-dialog-body'>
                    <div>
                        ...
                        <canvas id="leftCanvas" width="320" height="235"></canvas>
                        <button type="button" class="clear">Clear</button>
                    </div>
                    <div>
                        <img id="right-image" src=""/>
                        <canvas id="rightCanvas" width="320" height="235"></canvas>
                        <button type="button" class="clear">Clear</button>
                    </div>
                    <br/>
        ...
        <script src="front-end-frameworks/javascript/main.min.js"></script>
        <script>
                    (function ($) {
                        // main menu toggle
                        $("#menu-toggler").change(function () {
                            if (this.checked)
                                ...
                                $(".main-menu").addClass("slide-to-left")
                                        ...
                                        .find('input[name="main-menu"]:checked')
                                        .prop('checked', false)
                                        .change();
                            }
                        });
                        ...
                        $("#show-edit-account-details").click(function () {
                            var successCallback = function (body) {
                                pnnl.dialog.createDialog("edit-account-details-dialog")
                                        ...
                                        .setOnOpenCallback(function (dialogId) {
                                            ...
                                            $.ajax("/msiquickview/app/accounts/<%= org.apache.shiro.SecurityUtils.getSubject().getPrincipal()%>", {method: "GET", dataType: "json"})
                            ...
                            getHtmlFragment('edit-account-details-form-fragment.min.html', successCallback, $('.edit-account-details-dialog'));
                        });
                        ...
                        $("#tabs-container")
                                ...
                                .change(function () {
                                    ...
                                    if (this.classList.contains('images')) {
                                        ...
                                        if (this.dataset.totalQuantity === '0')
                                            $('#select-a-tool-toggler').attr('disabled', 'disabled');
                                        else
                                            $('#select-a-tool-toggler').attr('disabled', null);
                                        // if the user clicks the cdf, hdf, or excel tab, we hide the tool selection
                                        // so if they click on this image tab again and if they have selected a tool before, we show the cancel tool button
                                        if ($("#select-a-tool-toggler span").attr('id') !== "none")
                                            $("#tools #select-tool-cancel").css('visibility', 'visible');
                                        // Only the 'Warp' tool has the checkmark which signifies 'done' button and this tool requires 2 images to be selected
                                        // so if the user navigatves back to this tab content container and this condition is true, we display the checkmark
                                        if ($(".selected-image").length === 2)
                                            $("#tools #select-tool-done").css('visibility', 'visible');
                                        ...
                                        if (this.id === "rois-roiImages-tab") {
                                            ...
                                            $("#add-roi").css('display',"inline-block");
                                        } else if (this.id === "optical-tab")
                                            $("#upload-optical-image").css('display', 'inline-block');
                                    } else
                        ...
                        $("footer #pub").click(function (event) {
                            ...
                            var successCallback = function (pubFragment) {
                                ...
                                d3publicationContainer.transition()
                                        .duration(400)
                                        .style("display", "block")
                                        .style("opacity", "1")
                                ...
                                $(".publications .my-dialog-close-btn").click(function (event) {
                                    ...
                                    $(d3publicationContainer.node()).fadeOut(400, function () {
                                        $(this).css("opacity", "0")
                                                .find(".my-dialog-body")
                                                .css("opacity", "0")
                                                .find("li")
                            ...
                            getHtmlFragment('publications-fragment.min.html', successCallback, $('.publications'));
                        });
                        ...
                        $("footer #usage-guide").click(function (event) {
                            ...
                            var successCallback = function (fragment) {
                                ...
                                $howtoContainer.fadeIn();
                            };
                            getHtmlFragment('usage-guide-fragment.min.html', successCallback, $howtoContainer);
                        });
                        ...
                        $("#show-admin-console").click(function () {
                            ...
                            getHtmlFragment('admin-console-fragment.min.html', successCallback, $adminConsoleContainer);
                        });
